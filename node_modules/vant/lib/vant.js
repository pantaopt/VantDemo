...
/* harmony default export */ var es_picker = (create({
  render: function render() {
    ...
    return _c('div', {
      ...
      class: _vm.b('cancel'),
      domProps: {
        "textContent": _vm._s(_vm.cancelButtonText || _vm.$t('cancel'))
      },
      on: {
        "click": function click($event) {
          _vm.emit('cancel');
      ...
      class: _vm.b('confirm'),
      domProps: {
        "textContent": _vm._s(_vm.confirmButtonText || _vm.$t('confirm'))
      },
      on: {
        "click": function click($event) {
          _vm.emit('confirm');
  ...
  render: function render() {
    ...
    return _c('div', {
      ...
      attrs: {
        ...
        "type": "danger",
        "text": _vm.saveButtonText || _vm.$t('save')
      },
      on: {
        "click": _vm.onSave
      }
      ...
      attrs: {
        ...
        "text": _vm.deleteButtonText || _vm.$t('delete')
      },
      on: {
        "click": _vm.onDelete
      }
...
/* harmony default export */ var Item = (create({
  render: function render() {
    ...
    return _c('cell', {
      ...
      class: _vm.b('address'),
      domProps: {
        "textContent": _vm._s(_vm.data.address)
      }
    })]), _c('icon', {
      class: _vm.b('edit'),
      attrs: {
...
/* harmony default export */ var address_list = (create({
  render: function render() {
    ...
    return _c('div', {
      ...
      domProps: {
        "textContent": _vm._s(_vm.disabledText)
      }
...
/* harmony default export */ var card = (create({
  render: function render() {
    ...
    return _c('div', {
      ...
      class: _vm.b('price')
    }, [_vm._t("price", [_vm._v(_vm._s(_vm.currency) + " " + _vm._s(_vm.price))])], 2) : _vm._e(), _vm.isDef(_vm.originPrice) ? _c('div', {
      class: _vm.b('origin-price')
    }, [_vm._v("\n        " + _vm._s(_vm.currency) + " " + _vm._s(_vm.originPrice) + "\n      ")]) : _vm._e(), _vm.isDef(_vm.num) || _vm.$slots.num ? _c('div', {
      class: _vm.b('num')
    }, [_vm._t("num", [_vm._v("x " + _vm._s(_vm.num))])], 2) : _vm._e()])], 2), _vm.$slots.footer ? _c('div', {
      class: _vm.b('footer')
...
/* harmony default export */ var coupon_list = (create({
  render: function render() {
    ...
    return _c('div', {
      ...
      domProps: {
        "textContent": _vm._s(_vm.$t('empty'))
      }
    })]) : _vm._e()], 2)]), _c('tab', {
      attrs: {
...
function datetime_picker_padZero(val) {
  ...
  methods: {
    correctValue: function correctValue(value) {
      ...
      if (!isDateType) {
        ...
        hour = datetime_picker_padZero(Object(utils["g" /* range */])(hour, this.minHour, this.maxHour));
        minute = datetime_picker_padZero(Object(utils["g" /* range */])(minute, this.minMinute, this.maxMinute));
        return hour + ":" + minute;
      } // date type
    ...
    updateColumnValue: function updateColumnValue(value) {
      ...
      if (this.type === 'time') {
        ...
        values = [formatter('year', "" + value.getFullYear()), formatter('month', datetime_picker_padZero(value.getMonth() + 1)), formatter('day', datetime_picker_padZero(value.getDate()))];

        if (this.type === 'datetime') {
          values.push(formatter('hour', datetime_picker_padZero(value.getHours())), formatter('minute', datetime_picker_padZero(value.getMinutes())));
        }
...
/* harmony default export */ var list = (create({
  render: function render() {
    ...
    return _c('div', {
      ...
      domProps: {
        "textContent": _vm._s(_vm.loadingText || _vm.$t('loading'))
      }
    })])], 2) : _vm._e(), _vm.finished && _vm.finishedText ? _c('div', {
      class: _vm.b('finished-text'),
      domProps: {
        "textContent": _vm._s(_vm.finishedText)
      }
    }) : _vm._e()], 2);
  },
  name: 'list',
...
/* harmony default export */ var pagination = (create({
  render: function render() {
    ...
    return _c('ul', {
      ...
      domProps: {
        "textContent": _vm._s(_vm.prevText || _vm.$t('prev'))
      },
      on: {
        "click": function click($event) {
      ...
      domProps: {
        "textContent": _vm._s(_vm.nextText || _vm.$t('next'))
      },
      on: {
        "click": function click($event) {
          _vm.selectPage(_vm.value + 1);
...
/* harmony default export */ var pull_refresh = (create({
  render: function render() {
    ...
    return _c('div', {
      ...
      class: _vm.b('head')
    }, [_vm._t(_vm.status, [_vm.status === 'pulling' || _vm.status === 'loosing' ? _c('div', {
      class: _vm.b('text'),
      domProps: {
        "textContent": _vm._s(_vm.text)
      }
    }) : _vm._e(), _vm.status === 'loading' ? _c('div', {
      class: _vm.b('loading')
    }, [_c('loading'), _c('span', {
      domProps: {
        "textContent": _vm._s(_vm.text)
      }
    })], 1) : _vm._e()])], 2), _vm._t("default")], 2)]);
  },
  name: 'pull-refresh',
  mixins: [touch],
  props: {
...
/* harmony default export */ var submit_bar = (create({
  render: function render() {
    ...
    return _c('div', {
      ...
      domProps: {
        "textContent": _vm._s(_vm.label || _vm.$t('label'))
      }
    }), _c('span', {
      class: _vm.b('price')
      ...
      attrs: {
        ...
        "disabled": _vm.disabled,
        "loading": _vm.loading,
        "text": _vm.loading ? '' : _vm.buttonText
      },
      on: {
        "click": function click($event) {
          _vm.$emit('submit');
